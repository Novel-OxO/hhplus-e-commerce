...
export class OrdersController {
  ...
  async createOrder(@Body() body: CreateOrderRequestDto): Promise<CreateOrderResponseDto> {
    ...
    return {
      ...
      orderAmount: order.getTotalPrice().getValue(),
      discountAmount: order.getDiscountPrice().getValue(),
      finalAmount: order.getFinalPrice().getValue(),
      pointsUsed: order.getFinalPrice().getValue(),
      coupon: couponInfo,
      pointBalance: {
