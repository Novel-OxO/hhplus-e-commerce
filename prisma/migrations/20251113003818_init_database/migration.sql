...
CREATE TABLE `product_view_logs` (
    ...
    INDEX `product_view_logs_product_id_idx`(`product_id`),
    INDEX `product_view_logs_viewed_at_idx`(`viewed_at`),
    PRIMARY KEY (`log_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `product_rankings` (
    ...
    INDEX `product_rankings_calculated_at_idx`(`calculated_at`),
    PRIMARY KEY (`product_id`, `calculated_at`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
